...
public class MainActivityOLD extends Activity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnGetCroppedImageCompleteListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Button_load).setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                CropImageHelper.startPickImageActivity(MainActivityOLD.this);
            }
        });
    }
