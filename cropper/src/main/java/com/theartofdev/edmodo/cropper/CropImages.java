...
public final class CropImages {
   ...
   *     they are granted
   */
  public static boolean isReadExternalStoragePermissionsRequired(@NonNull Context context, @NonNull ArrayList<Uri> uri)
  {
   ...
   * @return builder for Crop Image Activity
   */
  public static ActivityBuilder activity(@Nullable ArrayList<Uri> uri) {
  ...
  public static final class ActivityBuilder {
    ...
    @Nullable private final ArrayList<Uri> mSource;

    /** Options for image crop UX */
    private final CropImageOptions mOptions;

    private ActivityBuilder(@Nullable ArrayList<Uri> source) {
      mSource = source;
  ...
  public static final class ActivityResult implements Parcelable
  {
    ...
    public ActivityResult(ArrayList<Uri> originalUri, ArrayList<Uri> resultUri, Exception error)
    {
    ...
    public ArrayList<Uri> getOriginalUri()
    {
      return mOriginalUri;
    }

    public ArrayList<Uri> getResultUri()
    {
      return mResultUri;
    }
